...
class BiddingGui(object):
    ...
    def __init__(self, game_manager, player1, player2):
        ...
        root = Tk()
        root.wm_title("The Bidding Game")
        root.lift()
...
def main(argv):
    ...
    try:
        ...
        print('game_zone.py -d <dimension> [-a <agentA> -b <agentB> -l <depth-limit> -c -o -m]')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print('game_zone.py -d <dimension> -a <agentA> [-b <agentB> -l <depth-limit> -c -o]')
            sys.exit()
